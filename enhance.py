...
def main(args):
    ...
    if not pretrained:
        ...
        model_checkpoint = f'/home/xuxi/emo_enhance/model/{args.model}_fineTuneModel.pt'#os.path.join(args.result_folder, '%s_%s%s.pth' % (args.model.replace('/', '-'), args.dataset, suffix))

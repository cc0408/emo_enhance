...
if __name__ == '__main__':
    ...
    for idx in range(0, 10):
        ...
        messages = f"The original sentence is :{sentence}. The sentence that has a stronger {label} emotion and maintains the same semantics by adding and replacing within three words is:"
